...
async function addRow() {
    try {
        ...
        // plankosten_variabel, plankosten_gesamt, istkosten, stueck_soll, stueck_ist als newRow
...
<template>
    <div>
      ...
      <AuthenticatedLayout>
          <template #header>
              <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">plankostenrechnung</h2>
          </template>
